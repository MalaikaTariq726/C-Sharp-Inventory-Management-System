...
namespace DbProject.Resources
{
    public class RoundPanel : Panel
    {
        ...
        private GraphicsPath graphicsPanelPath(RectangleF rect, float radius)
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphs.FillRectangle(brush, ClientRectangle);
            RectangleF rectF = new RectangleF(0, 0, this.Width, this.Height);
            if (borderRadius > 2)
            {
                using (GraphicsPath path = graphicsPanelPath(rectF, borderRadius))
